...
public class TypeGoodsAdapter extends RecyclerView.Adapter<TypeGoodsAdapter.ViewHolder> {
    ...
    public TypeGoodsAdapter(Context context, List<FindDataBean.FindNewestInfo> goodsList, boolean isFindGoods) {
    ...
    @NonNull
    @Override
    public TypeGoodsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_newest_grid_view, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull TypeGoodsAdapter.ViewHolder holder, int position) {
        // 根据位置得到对应的数据
        ...
        holder.ll_newest_item_main.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.putExtra(FindFragmentAdapter.GOODS_BEAN, goods);
