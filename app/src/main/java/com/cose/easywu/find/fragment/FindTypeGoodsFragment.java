...
public class FindTypeGoodsFragment extends BaseFragment {
    ...
    public void initData() {
        ...
        adapter = new TypeGoodsAdapter(mContext, mGoodsList, true);
    ...
    private void initListener() {
        mRefreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(final RefreshLayout refreshlayout) {
                ...
                HttpUtil.sendPostRequest(Constant.TYPE_FIND_GOODS_URL, jsonObject.toString(), new Callback() {
                    @Override
