...
public class MyReleaseFindGoodsAdapter extends RecyclerView.Adapter<MyReleaseFindGoodsAdapter.ViewHolder> {

    private Context mContext;
    private List<ReleaseFindGoods> goodsList;
    private String u_id;
    ...
    public MyReleaseFindGoodsAdapter(Context context) {
        mContext = context;
        goodsList = LitePal.where("fg_state=?", "0").order("fg_updateTime desc").find(ReleaseFindGoods.class);
    ...
    @NonNull
    @Override
    public MyReleaseFindGoodsAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.item_myreleasegoods, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final MyReleaseFindGoodsAdapter.ViewHolder holder, final int position) {
        final ReleaseFindGoods goods = goodsList.get(position);
    ...
    public void setGoodsList(List<ReleaseFindGoods> goodsList) {
    ...
    public interface OnPolishClick {
        void click(View view, TextView tvUpdateTime, ReleaseFindGoods goods);
    }
