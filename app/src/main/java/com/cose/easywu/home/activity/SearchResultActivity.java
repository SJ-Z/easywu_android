...
public class SearchResultActivity extends BaseActivity {
    ...
    private TextView tvBack, tvResultNum;
    ...
    private void initListener() {
        ...
        refreshLayout.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh(final RefreshLayout refreshlayout) {
                ...
                HttpUtil.sendPostRequest(Constant.SEARCH_GOODS_URL, jsonObject.toString(), new Callback() {
                    @Override
                    ...
                    public void onResponse(Call call, Response response) throws IOException {
                        ...
                        runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
                                tvResultNum.setText(String.valueOf(goodsList.size()));
        ...
        refreshLayout.setOnLoadMoreListener(new OnLoadMoreListener() {
            ...
            public void onLoadMore(final RefreshLayout refreshlayout) {
                if (isBottom) {
                    ToastUtil.showMsg(SearchResultActivity.this, "没有更多数据了", Toast.LENGTH_SHORT);
                    return;
                }
                pageCode++;
                JSONObject jsonObject = new JSONObject();
    ...
    private void initView() {
        tvBack = findViewById(R.id.tv_search_result_back);
        tvResultNum = findViewById(R.id.tv_search_result_num);
        ivLoading = findViewById(R.id.iv_search_result_loading);
        ...
        refreshLayout = findViewById(R.id.refreshLayout_search_result);
