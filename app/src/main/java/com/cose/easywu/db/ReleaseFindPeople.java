...
public class ReleaseFindPeople extends LitePalSupport {
    ...
    public ReleaseFindPeople() {
    }

    public ReleaseFindPeople(String fg_id, String fg_name, String fg_desc, String fg_pic1, String fg_pic2, String fg_pic3, int fg_state, int fg_like, Date fg_updateTime, String fg_u_id, String fg_ft_id) {
        this.fg_id = fg_id;
